...
def _cmd_pg_load(args: Namespace, _: RuntimeConfig) -> None:
    from law_shared.scripts.supabase_load import main as load_main  # type: ignore
...
def _cmd_pg_load_jsonl(args: Namespace, _: RuntimeConfig) -> None:
    from law_shared.scripts.pg_load_jsonl import main as load_jsonl_main  # type: ignore
...
def _cmd_pg_search(args: Namespace, _: RuntimeConfig) -> None:
    from law_shared.legal_tools.pg_search import search_bm25  # type: ignore
