...
def _cmd_opensearch_load(args: Namespace, _: RuntimeConfig) -> None:
    from law_shared.scripts.opensearch_load import main as opensearch_main  # type: ignore
...
def _cmd_opensearch_search(args: Namespace, _: RuntimeConfig) -> None:
    from law_shared.legal_tools.opensearch_search import search_opensearch  # type: ignore
