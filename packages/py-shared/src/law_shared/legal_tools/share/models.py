...
class JSONBCompat(TypeDecorator):
    """SQLite-friendly JSONB replacement."""
...
class Chat(UUIDPrimaryKeyMixin, Base):
    ...
    last_context: Mapped[dict | None] = mapped_column("lastContext", JSONBCompat())
...
class Document(UUIDPrimaryKeyMixin, Base):
    ...
    text_type: Mapped[str] = mapped_column(
        "text", String(32), server_default=text("'text'"), nullable=False
    )
