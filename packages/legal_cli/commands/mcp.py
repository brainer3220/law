...
def _cmd_mcp_context7(args: Namespace, _: RuntimeConfig) -> None:
    from packages.legal_tools.mcp_client import MCPUnavailable, context7_docs  # type: ignore
...
def _cmd_mcp_ast_grep(args: Namespace, _: RuntimeConfig) -> None:
    from packages.legal_tools.mcp_client import MCPUnavailable, ast_grep_find  # type: ignore
