...
from packages.legal_cli import config
from packages.legal_cli.commands import ask, stats
from packages.legal_cli.runner import build_parser
...
def test_ask_command_enables_offline_and_prints_answer(
    ...
    monkeypatch.setitem(sys.modules, "packages.legal_tools.agent_graph", module)
