...
def test_search_law_parses_results(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("law_shared.legal_tools.law_go_kr.request.urlopen", fake_urlopen)
...
def test_tool_law_go_search_returns_hits(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("law_shared.legal_tools.agent_graph.search_law", fake_search_law)
...
def test_fetch_law_detail_parses_articles(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("law_shared.legal_tools.law_go_kr._call_api", fake_call_api)
...
def test_tool_law_go_detail_returns_hits(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("law_shared.legal_tools.agent_graph.fetch_law_detail", fake_fetch_law_detail)
...
def test_tool_law_go_interpretations_returns_hits(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "law_shared.legal_tools.agent_graph.search_law_interpretations",
...
def test_tool_law_go_interpretation_detail_returns_hit(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "law_shared.legal_tools.agent_graph.fetch_law_interpretation",
