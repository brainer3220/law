...
from law_shared.legal_tools.multi_turn_chat import ChatResponse, PostgresChatManager
...
def test_stream_messages_streams_tool_calls_before_content(
    ...
    monkeypatch.setattr(
        "law_shared.legal_tools.multi_turn_chat.get_langsmith_callbacks",
        lambda: [],
    )
    ...
    monkeypatch.setattr(
        "law_shared.legal_tools.multi_turn_chat.messages_from_dict",
